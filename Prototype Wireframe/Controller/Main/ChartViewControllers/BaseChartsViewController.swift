//
//  BaseChartsViewController.swift
//  Prototype Wireframe
//
...
class BaseChartsViewController: UIViewController, ChartViewDelegate {
...
extension BaseChartsViewController: UITableViewDelegate, UITableViewDataSource {
